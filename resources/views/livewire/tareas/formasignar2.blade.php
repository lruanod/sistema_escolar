...
<div class="row form-group">
    <label for="murl2" class="col-5 text-white">Archivo</label>
    <input type="file" class="form-control col-md-5" wire:model="murl2" id="{{$identificador4}}">
    @error('murl2') <span class="text-warning">{{$message}}</span> @enderror
</div>
...
<div class="card-body align-content-center">
    <div wire:loading wire:target="murl2" class="alert alert-danger">
        <ul>
