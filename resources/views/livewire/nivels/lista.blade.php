<div class="col-12 mt-3">
    <div class="card" style="background: linear-gradient(to bottom, #1cc88a  , #18181c );" >
        <h4 class="text-center text-white">Niveles</h4>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="row form-group">
                            <label for="buscar" class="text-white">Nombre del nivel</label>
                    ...
                    <div class="col-md-3">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addnivel" title="Agragar Nivel acedémicos">
...
<div class="col-12 mt-2">
    <div class="card col-12" style="background: linear-gradient(to bottom, #1cc88a  , #18181c );" >
        <h4 class="text-center text-white">Lista niveles</h4>
    </div><br>
    <div class="table-responsive">
        ...
        @foreach($nivels as $nivel)
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-info"  data-toggle="modal" data-target="#editnivel" title="Editar nivel" wire:click="edit({{$nivel->id}})" >
