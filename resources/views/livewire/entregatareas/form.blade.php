...
<div class="row form-group">
    <label for="eurl" class="col-5 text-white">Archivo</label>
    <input type="file" class="form-control col-md-5" wire:model="eurl" id="{{$identificador3}}" multiple>
    @error('eurl') <span class="text-warning">{{$message}}</span> @enderror
</div>
...
<div class="card-body align-content-center">
    <div wire:loading wire:target="eurl" class="alert alert-danger">
        <ul>
