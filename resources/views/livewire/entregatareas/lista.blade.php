    ...
    <div class="table-responsive">
        ...
        @foreach($tareas as $tarea)
            <tr>
                    ...
                    @foreach($estudiantearchivos as $earchivo)
                        @if($tarea->tareaid==$earchivo->entregatarea->tarea_id)
                            ...
                            <br>
                                ...
                                <a type="button" class="btn-sm btn-info"  data-toggle="modal" data-target="#edittarea" title="Editar tarea/actividad" wire:click="edit({{$earchivo->idd}})" >
                                    <i class="fas fa-pencil-alt fa-fw"></i>
                                </a>
                                <a type="button" class="btn-sm btn-danger " title="Eliminar archivo" wire:click="destroy({{$earchivo->idd}},{{$earchivo->entregatarea_id}})" >
                ...
                <td>
                    @if($tarea->ffinalizacion >= now())
                    <button type="button" class="btn btn-success"  data-toggle="modal" data-target="#addentarea" title="Agregar tarea/actividad" wire:click="asig({{$tarea->tareaid}})" >
