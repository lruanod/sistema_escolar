<!-- modal buscarciclo-->
<div wire:ignore.self class="modal fade bd-example-modal-lg" id="addciclo" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title " id="addciclo">Registrar ciclo</h5>
