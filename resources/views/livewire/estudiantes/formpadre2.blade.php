...
<div class="row form-group">
    ...
    <input type="email" class="form-control col-md-5" wire:model="pcorreo" readonly="readonly">
...
<div class="row form-group">
    ...
    <input type="text" class="form-control col-md-5" wire:model="pusuario" readonly="readonly">
